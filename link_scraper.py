...
def get_a_tags(url): #Providing the link of a page of problems to retrieve the links of problems int that page
    driver=webdriver.Chrome()
    print(url)
    driver.get(url)
    time.sleep(10)#Waits till the page is completely loaded.
